...
export type FarcasterSignerInitResponseBody =
  | FarcasterSignerInitResponseBody.UnionMember0
  | FarcasterSignerInitResponseBody.UnionMember1
  | FarcasterSignerInitResponseBody.UnionMember2;

export namespace FarcasterSignerInitResponseBody {
...
export type FarcasterSignerStatusResponseBody =
  | FarcasterSignerStatusResponseBody.UnionMember0
  | FarcasterSignerStatusResponseBody.UnionMember1
  | FarcasterSignerStatusResponseBody.UnionMember2;

export namespace FarcasterSignerStatusResponseBody {
  export interface UnionMember0 {
    public_key: string;
...
export namespace MfaSMSInitRequestBody {
...
export namespace PasskeyAuthenticateRequestBody {
  export interface AuthenticatorResponse {
    id: string;
...
export namespace PasskeyInitAuthenticateResponseBody {
  export interface Options {
    challenge: string;
...
export namespace PasskeyInitLinkResponseBody {
  export interface Options {
    challenge: string;
...
export namespace PasskeyInitRegisterResponseBody {
  export interface Options {
    challenge: string;
...
export namespace PasskeyLinkRequestBody {
  export interface AuthenticatorResponse {
    id: string;
...
export namespace PasskeyRegisterRequestBody {
  export interface AuthenticatorResponse {
    id: string;
...
export namespace TelegramAuthenticateRequestBody {
...
export namespace TelegramLinkRequestBody {
  export interface TelegramAuthResult {
    id: number | null;
