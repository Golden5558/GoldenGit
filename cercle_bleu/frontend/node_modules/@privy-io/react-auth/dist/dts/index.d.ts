...
import { Address, HttpTransport, Hex, SignableMessage } from 'viem';
...
import { P as PrivyEvents } from './events-context-DJ7XN_9I.js';
export { C as CallbackError } from './events-context-DJ7XN_9I.js';
...
declare const getPublicClient: (chainId: number, chains: Chain[], rpcConfig: RpcConfig, options: {
    ...
    prepareTransactionRequest: <const request extends viem.PrepareTransactionRequestRequest<Chain, chainOverride>, chainOverride extends viem.Chain | undefined = undefined, accountOverride extends viem.Account | Address | undefined = undefined>(args: viem.PrepareTransactionRequestParameters<Chain, viem.Account | undefined, chainOverride, accountOverride, request>) => Promise<viem.UnionRequiredBy<Extract<viem.UnionOmit<viem.ExtractChainFormatterParameters<viem.DeriveChain<Chain, chainOverride>, "transactionRequest", viem.TransactionRequest>, "from"> & (viem.DeriveChain<Chain, chainOverride> extends infer T_1 ? T_1 extends viem.DeriveChain<Chain, chainOverride> ? T_1 extends viem.Chain ? {
        ...
        authorizationList: viem.TransactionSerializableEIP7702["authorizationList"];
    } ? "eip7702" : never) | (request["type"] extends string | undefined ? Extract<request["type"], string> : never)>) ? T_7 extends "eip7702" ? viem.TransactionRequestEIP7702 : never : never : never)>> & {
        chainId?: number | undefined;
    ...
    extend: <const client extends {
        ...
        Parameters?: unknown | undefined;
        ReturnType: unknown;
    }[]], { [K in keyof client]: client[K]; } & viem.PublicActions<HttpTransport, Chain>>;
};
...
interface PrivyInterface {
    ...
    /**
     * @deprecated use the `useExportWallet` hook instead
     *
...
declare class PrivyClient {
     ...
     */
    initializeConnectorManager({ walletConnectCloudProjectId, rpcConfig, chains, defaultChain, store, walletList, shouldEnforceDefaultChainOnConnect, externalWalletConfig, appName, walletChainType, setBaseAccountSdk, connectorsDebugLogs, }: {
...
type UseFundWalletWithBankDepositOptions = {
    /**
     * Configuration for the supported source assets
     */
    source: {
        /**
         * FIAT lowercase (e.g. usd or eur).
         */
        assets: ('usd' | 'eur' | 'mxn' | 'brl' | 'gbp')[];
        /**
         * The default selected source asset.
         */
        defaultAsset?: 'usd' | 'eur' | 'mxn' | 'brl' | 'gbp';
        /**
         * @deprecated
         *
         * Unused legacy field, will be removed in a future release
         */
        selectedAsset?: any;
    };
    /**
     * Configuration for the desired destination asset and wallet
     */
    destination: {
        /**
         * Token symbol lowercase (e.g. usdc)
         */
        asset: 'usdc';
        /**
         * CAIP2 (e.g. eip155:1 or solana:EtWTRABZaYq6iMfeYKouRu166VU2xqa1)
         */
        chain: `${string}:${string}`;
        /**
...
type UseFundWalletWithBankDepositResult = {
    /**
     * Opens the Privy modal and initiates the Bank transfer flow.
     *
     * @param opts options specifying how to fund the wallet
     * @returns an empty object indicating success, throws if there is an error
     * @throws
     */
    fund: (opts: UseFundWalletWithBankDepositOptions) => Promise<Record<string, never>>;
};
/**
 * @experimental This interface may change at any time
 *
 * Hook to trigger a funding flow using a bank transfer.
 *
 * @returns a function that triggers the flow
 */
declare const useFundWalletWithBankDeposit: () => UseFundWalletWithBankDepositResult;
...
type EncryptedWalletKey = {
    /** Base64-encoded HPKE ciphertext containing the private key */
    ciphertext: string;
...
interface UseGetWalletPrivateKeyInterface {
    /**
     * Exports an embedded wallet's private key, encrypted to the provided public key.
     *
     * This is used for programmatic key export where the app provides its own public key
     * and receives the HPKE-encrypted private key. The app is responsible for decrypting
     * the response using the corresponding private key.
     *
     * Only supported for unified stack wallets (TEE wallets). On-device wallets are not supported.
     *
     * @experimental
     *
     * @param options.address The wallet address to export
     * @param options.recipientPublicKey Base64-encoded SPKI P-256 public key to encrypt to
     * @returns The HPKE-encrypted private key data
     */
    getWalletPrivateKey: (options: {
        address: string;
        recipientPublicKey: string;
    }) => Promise<EncryptedWalletKey>;
}
declare function useGetWalletPrivateKey(): UseGetWalletPrivateKeyInterface;
