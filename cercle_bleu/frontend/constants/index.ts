export const consentContractAddress = process.env.NEXT_PUBLIC_CERCLE_CONSENT_ADDRESS;
export const tokenContractAddress = process.env.NEXT_PUBLIC_CERCLE_TOKEN_ADDRESS;
...
export const tokenContractABI = [
    ...
    },
    {
      ...
      "name": "PatientAuthorizationChanged",
      "type": "event"
    },
    {
      "anonymous": false,
...
export const consentContractABI = [
    ...
    {
      "inputs": [],
      "name": "PatientIdDoesNotExist",
      "type": "error"
    },
    {
      "inputs": [],
      "name": "PatientNotRegistered",
      "type": "error"
    },
    {
      "inputs": [],
      "name": "StudyIdRequired",
      "type": "error"
    },
    {
      "inputs": [],
      "name": "StudyNotAuthorized",
      "type": "error"
    },
    {
      "inputs": [],
      "name": "StudyNotAuthorizedForRevocation",
      "type": "error"
    },
    {
      "inputs": [],
    ...
    },
    {
      ...
      "name": "getStudyActiveConsentCount",
      "outputs": [
        {
          "internalType": "uint256",
          "name": "",
