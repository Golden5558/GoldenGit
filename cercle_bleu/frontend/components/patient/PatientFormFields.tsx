    ...
    <div className="space-y-6 max-w-md mx-auto">
      {showBlockchainId && blockchainId && (
        <div className="text-center">
          ...
          <p className="text-sm text-green-600">Blockchain Id: {blockchainId}</p>
        </div>
      )}
      ...
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-gray-500">
            Utilisé pour personnaliser l&apos;analyse de vos données de santé. Jamais transmis sans votre consentement explicite.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-gray-500">
            Pris en compte dans les modèles de recherche sur le diabète. Vos données sont toujours anonymisées avant d&apos;être partagées.
          </p>
        </div>

        <div>
          <Label htmlFor="diabeteType">Type de diabète</Label>
          <Select value={formData.diabeteType} onValueChange={(value) => updateFormData('diabeteType', value)}>
            <SelectTrigger>
          ...
          <p className="mt-1 text-xs text-gray-500">
            Permet de vous connecter aux études scientifiques correspondant à votre profil. Vous restez libre d&apos;accepter ou refuser chaque étude.
          </p>
        </div>
