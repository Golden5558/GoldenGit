...
CREATE TABLE "patient" (
    "id" SERIAL NOT NULL,
    "onChainPatientId" BIGINT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "patient_onChainPatientId_key" ON "patient"("onChainPatientId");
...
-- CreateIndex
CREATE INDEX "idx_patient_on_chain_id" ON "patient"("onChainPatientId");
...
-- CreateIndex
CREATE UNIQUE INDEX "study_onChainStudyId_key" ON "study"("onChainStudyId");
